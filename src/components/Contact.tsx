            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4>Email</h4>
                    <p className="text-muted-foreground">sharma.gaurav@northeastern.edu</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4>Phone</h4>
                    <p className="text-muted-foreground">+1 (857) 340-0140</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4>Location</h4>
                    <p className="text-muted-foreground">Boston, Massachusetts, United States</p>
                  </div>
                </div>
              </CardContent>
            </Card>
