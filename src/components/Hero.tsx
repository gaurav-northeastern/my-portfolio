        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-xl sm:text-2xl text-muted-foreground max-w-lg">
                  Software Engineer & Master's Student at Northeastern
                  University
                </p>

                <p className="text-lg text-muted-foreground/80 max-w-md">
                  Specializing in full-stack development with React, Node.js,
                  and Spring Boot. Experience in building scalable applications,
                  CI/CD automation, and AI-powered solutions.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 justify-center lg:justify-start">
              ...
              >
                <a
                  href="https://github.com/gaurav-northeastern"
                  target="_blank"
              ...
              >
                <a
                  href="https://www.linkedin.com/in/gauravsharmax/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                >
              ...
              >
                <a
                  href="mailto:sharma.gaurav@northeastern.edu"
                  aria-label="Email"
                >
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              ...
              <div className="text-center lg:text-left">
                <div className="text-2xl md:text-3xl mb-1">1+ Yr</div>
